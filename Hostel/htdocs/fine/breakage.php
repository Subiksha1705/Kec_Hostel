...
<body>
    ...
    <script>
        ...
        rollNumberInput.addEventListener('change', async () => {
            ...
            const response = await fetch(`student_data.php?Roll_No=${rollNumber}`);
    ...
    <script>
    function fetchData(roll-number) {
        fetch('student_data.php?roll-number=' + roll-number)
            .then(response => response.json())
            .then(data => {
                document.getElementById('name').value = data.name;
                document.getElementById('email').value = data.email;
                document.getElementById('room-number').value = data.roomNumber;
            })

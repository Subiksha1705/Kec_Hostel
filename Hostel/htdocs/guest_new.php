...
$query = "SELECT name, description, total_rooms, capacity, image FROM home "; // Adjust the query as per your database structure
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Echo HTML code with PHP variables embedded
        echo '<!-- Card: City -->
                  ...
                  <br>
                    <div class="flip-card">
                        <div class="flip-card__container">
                            <div class="card-front">
                               ...
                               <g>
                                   ...
                                   <path d="M58,11.9c0-0.1,0-0.1,0-0.2c0-0.1,0-0.1-0.1-0.2c0-0.1,0-0.1-0.1-0.2c0-0.1-0.1-0.1-0.1-0.2c0,0,0-0.1-0.1-0.1c0,0,0,0,0,0
                                       ...
                                       c0,0.1-0.1,0.1-0.1,0.2c0,0.1,0,0.1-0.1,0.2c0,0.1,0,0.1-0.1,0.2c0,0.1,0,0.1,0,0.2c0,0,0,0,0,0v5.4H22.1
                            ...
                            <div class="card-back">
                                <img src="'.$image.'" alt="" width="250px" height="240px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="inside-page">
                        <div class="inside-page__container">
                            ...
                            <p class="inside-page__text">
                              Total Number of rooms : '.$total_rooms.' rooms
                              Accommodation : '.$capacity.' capacity
                            </p>
                            <a href="#" class="inside-page__btn inside-page__btn--city">View Gallery</a>
                        </div>
                    </div>
                </div>
            </section>';
                ...
                <br>
                  <div class="flip-card">
                      <div class="flip-card__container">
                          ...
                          <div class="card-back">
                            <img src="h2.jpg" alt="" width="250px" height="240px">
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="inside-page">
                      <div class="inside-page__container">
                          <h3 class="inside-page__heading inside-page__heading--beach">
                              For THREE seater rooms
                          </h3>
                          <p class="inside-page__text">
                            Total Number of rooms : 250 rooms
                            Accomodation : 750 capacity
                          </p>
                          <a href="#" class="inside-page__btn inside-page__btn--beach">View Gallery</a>
                      </div>
                  </div>
              </div>
          </section>
              ...
              <br>
                <div class="flip-card">
                    <div class="flip-card__container">
                        ...
                        <div class="card-back">
                          <img src="h3.jpg" alt="" width="250px" height="240px">
                        </div>
                    </div>
                </div>
                ...
                <div class="inside-page">
                    <div class="inside-page__container">
                        <h3 class="inside-page__heading inside-page__heading--ski">
                            For THREE and FIVE seater rooms
                        </h3>
                        <p class="inside-page__text">
                          Total Number of rooms : 200 rooms
                          Accomodation : 600 capacity
                        </p>
                        <a href="#" class="inside-page__btn inside-page__btn--ski">View Gallery</a>
                    </div>
                </div>
            </div>
        </section>
